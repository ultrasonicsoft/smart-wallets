...
app.get('/getAllPaymentServicesForMerchant/:merchantId', auth, function (req, res) {
    // var queryData = url.parse(req.url, true).query;

    console.log('Merchant Id: ' + req.params.merchantId);
    executeSqlRequest(req, res, 'call getAllPaymentServicesForMerchant('+ req.params.merchantId + ');');
});
